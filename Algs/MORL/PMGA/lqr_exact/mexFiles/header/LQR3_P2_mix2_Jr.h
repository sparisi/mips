#ifndef LQR3_P2_mix2_Jr_H
#define LQR3_P2_mix2_Jr_H

double LQR3_P2_mix2_Jr(double* tv, int tdim, double* param, int pdim) {
...
double t121 = t14*t17*1.09E3;
double t122 = t116+t119+t121+1.9E1;
double t115 = fabs(t122/Up1-1.0);
double t118 = t14*t46*1.09E3;
double t124 = t41*t68*1.09E3;
double t125 = t116+t118+t124+1.9E1;
double t117 = fabs(t125/Up2-1.0);
double t127 = t50*t77*1.09E3;
double t128 = t118+t119+t127+1.9E1;
double t120 = fabs(t128/Up3-1.0);
double t123 = fabs(t122/AUp1-1.0);
double t126 = fabs(t125/AUp2-1.0);
double t129 = fabs(t128/AUp3-1.0);
double t0 = -(beta2-(beta1*(t123*t123+t126*t126+t129*t129))/(t115*t115+t117*t117+t120*t120))*sqrt((r2*t7*t10*t94+r5*t25*t28*t98+r8*t34*t37*t102)*(r3*t7*t10*t106+r6*t25*t28*t110+r9*t34*t37*t114)-(r3*t7*t10*t94+r6*t25*t28*t98+r9*t34*t37*t102)*(r2*t7*t10*t106+r5*t25*t28*t110+r8*t34*t37*t114));
