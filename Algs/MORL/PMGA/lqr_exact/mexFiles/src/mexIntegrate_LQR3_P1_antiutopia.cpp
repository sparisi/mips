...
#include "LQR3_P1_antiutopia_DL1.h"
#include "LQR3_P1_antiutopia_DL2.h"
#include "LQR3_P1_antiutopia_DL3.h"
#include "LQR3_P1_antiutopia_DL4.h"
#include "LQR3_P1_antiutopia_DL5.h"
#include "LQR3_P1_antiutopia_DL6.h"
#include "LQR3_P1_antiutopia_DL7.h"
#include "LQR3_P1_antiutopia_DL8.h"
#include "LQR3_P1_antiutopia_DL9.h"
#include "LQR3_P1_antiutopia_L.h"
...
void help() {
    mexPrintf("[L, DL] = mexIntegrate(lo, hi, Npoints, simplex, rho, params)\n");
    mexPrintf("\n");
    mexPrintf("INPUT \n");
    ...
    mexPrintf("\n");
    mexPrintf("OUTPUT \n");
    mexPrintf("  - L       : integral of manifold value L(rho)\n");
    mexPrintf("  - DL      : integral of the derivative of L(rho)\n");
}
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    OUT_DL = mxCreateDoubleMatrix(rdim,1,mxREAL);
    double* res = mxGetPr(OUT_DL);
    ...
    for (int i = 1; i <= rdim; ++i) {
        #define FUN_NAME(x) \
        case x: ff = LQR3_P1_antiutopia_DL ## x; break;
        switch ( i ) {
            FUN_NAME(1);
            FUN_NAME(2);
            FUN_NAME(3);
    ...
    // integrate Jr
    ff = LQR3_P1_antiutopia_L;
    double val = Integrate(ff, li, hi, tdim, Np, rho, rdim);
    OUT_L = mxCreateDoubleScalar(val);
}
