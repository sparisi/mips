...
#include "LQR3_P2_mix3_DL1.h"
#include "LQR3_P2_mix3_DL2.h"
#include "LQR3_P2_mix3_DL3.h"
#include "LQR3_P2_mix3_DL4.h"
#include "LQR3_P2_mix3_DL5.h"
#include "LQR3_P2_mix3_DL6.h"
#include "LQR3_P2_mix3_DL7.h"
#include "LQR3_P2_mix3_DL8.h"
#include "LQR3_P2_mix3_DL9.h"
#include "LQR3_P2_mix3_L.h"
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    for (int i = 1; i <= rdim; ++i) {
        #define FUN_NAME(x) \
        case x: ff = LQR3_P2_mix3_DL ## x; break;
        switch ( i ) {
            FUN_NAME(1);
            FUN_NAME(2);
            FUN_NAME(3);
