...
#include "LQR3_P2_mix1_DL1.h"
#include "LQR3_P2_mix1_DL2.h"
#include "LQR3_P2_mix1_DL3.h"
#include "LQR3_P2_mix1_DL4.h"
#include "LQR3_P2_mix1_DL5.h"
#include "LQR3_P2_mix1_DL6.h"
#include "LQR3_P2_mix1_DL7.h"
#include "LQR3_P2_mix1_DL8.h"
#include "LQR3_P2_mix1_DL9.h"
#include "LQR3_P2_mix1_L.h"
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    for (int i = 1; i <= rdim; ++i) {
        #define FUN_NAME(x) \
        case x: ff = LQR3_P2_mix1_DL ## x; break;
        switch ( i ) {
            FUN_NAME(1);
            FUN_NAME(2);
            FUN_NAME(3);
