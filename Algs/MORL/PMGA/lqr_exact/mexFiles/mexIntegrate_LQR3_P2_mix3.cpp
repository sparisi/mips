...
#include "header/LQR3_P2_mix3_Djr1.h"
#include "header/LQR3_P2_mix3_Djr2.h"
#include "header/LQR3_P2_mix3_Djr3.h"
#include "header/LQR3_P2_mix3_Djr4.h"
#include "header/LQR3_P2_mix3_Djr5.h"
#include "header/LQR3_P2_mix3_Djr6.h"
#include "header/LQR3_P2_mix3_Djr7.h"
#include "header/LQR3_P2_mix3_Djr8.h"
#include "header/LQR3_P2_mix3_Djr9.h"
#include "header/LQR3_P2_mix3_Jr.h"
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    for (int i = 1; i <= rdim; ++i) {
        #define FUN_NAME(x) \
        case x: ff = LQR3_P2_mix3_Djr ## x; break;
        switch ( i ) {
            FUN_NAME(1);
            FUN_NAME(2);
            FUN_NAME(3);
