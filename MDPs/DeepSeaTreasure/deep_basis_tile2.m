...
phi(1,:) = ( (state(1,:) >= 1 & state(1,:) <= 4) & ...
    (state(2,:) >= 1 & state(2,:) <= 4) & ~(state(1,:) == 1 & state(2,:) == 1) );
phi(2,:) = ( (state(1,:) >= 4 & state(1,:) <= 7) & ...
    (state(2,:) >= 1 & state(2,:) <= 4) );
phi(3,:) = ( (state(1,:) >= 7 & state(1,:) <= 10) & ...
    (state(2,:) >= 1 & state(2,:) <= 4) );
phi(4,:) = ( (state(1,:) >= 1 & state(1,:) <= 4) & ...
    (state(2,:) >= 4 & state(2,:) <= 7) );
phi(5,:) = ( (state(1,:) >= 4 & state(1,:) <= 7) & ...
    (state(2,:) >= 4 & state(2,:) <= 7) );
phi(6,:) = ( (state(1,:) >= 7 & state(1,:) <= 10) & ...
    (state(2,:) >= 4 & state(2,:) <= 7) );
phi(7,:) = ( (state(1,:) >= 1 & state(1,:) <= 4) & ...
    (state(2,:) >= 7 & state(2,:) <= 10) );
phi(8,:) = ( (state(1,:) >= 4 & state(1,:) <= 7) & ...
    (state(2,:) >= 7 & state(2,:) <= 10) );
phi(9,:) = ( (state(1,:) >= 7 & state(1,:) <= 10) & ...
    (state(2,:) >= 7 & state(2,:) <= 10) );
phi(10,:) = ( state(1,:) == 1 & state(2,:) == 1 );
