...
% REFERENCE
% [ORIGINAL] A P Wieland
% Evolving Controls for Unstable Systems (1991)
%
% [MODIFIED] S Loscalzo, R Wright, L Yu
% Predictive feature selection for genetic policy search (2014)
%
% In the modified version there is an additional 'no force' action, the 
% pole friction is missing, the timestep 'dt' is smaller, the state 
% constraints and the reward function are different, the pole is shorter 
% and the masses/lengths are bigger.
    ...
    methods
        ...
        function [nextstate, reward, absorb] = simulator(obj, state, action)
            ...
            idx = max(bsxfun(@lt, nextstate, obj.stateLB),[],1) | ...
