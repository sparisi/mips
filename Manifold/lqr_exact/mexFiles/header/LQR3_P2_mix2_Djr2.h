#ifndef LQR3_P2_mix2_Djr2_H
#define LQR3_P2_mix2_Djr2_H

double LQR3_P2_mix2_Djr2(double* tv, int tdim, double* param, int pdim) {
...
double t62 = t57*t61;
double t63 = t62-1.0;
double t64 = t1*t7*t9*1.8E1;
double t74 = t1*t7*t56*1.8E1;
double t65 = t64-t74;
...
double t85 = t1*t7*t27*t56*1.962E3;
double t76 = t75-t85;
double t80 = t51*t65*t66*1.09E3;
double t81 = t80-t1*t7*t27*t56*2.18E2;
double t89 = t22*t22;
double t90 = t41*t41;
double t91 = t48*t48;
...
double t185 = t1*t7*t9*t27*1.962E3;
double t186 = t1*t7*t9*t43*t66*1.962E4;
double t187 = t1*t7*t56*t66*t97*1.962E3;
double t193 = t23*t65*t66*1.962E3;
double t194 = t43*t65*t97*t184*2.18E3;
double t188 = t185+t186+t187-t193-t194;
double t189 = t1*t7*t9*t27*2.18E2;
double t190 = t1*t7*t9*t51*t66*1.962E4;
double t191 = t1*t7*t56*t66*t97*2.18E2;
...
double t203 = r2*t1*t7*t9*t99;
double t210 = r2*t7*t9*t192;
double t211 = r2*t1*t56*t99*t199*2.0;
double t204 = t200+t203-t210-t211;
double t205 = t7*t9*t104;
double t206 = r2*t1*t7*t9*t104;
double t208 = r2*t7*t9*t188;
double t209 = r2*t1*t56*t104*t199*2.0;
double t207 = t205+t206-t208-t209;
double t212 = r3*t7*t9*t188;
double t213 = r3*t1*t56*t104*t199*2.0;
double t218 = r3*t1*t7*t9*t104;
double t214 = t212+t213-t218;
double t215 = r3*t7*t9*t192;
double t216 = r3*t1*t56*t99*t199*2.0;
double t219 = r3*t1*t7*t9*t99;
double t217 = t215+t216-t219;
double t220 = t122*t192;
double t221 = t120*t188;
...
double t242 = t134*t192;
double t243 = t132*t188;
double t244 = t136*t188;
double t245 = t240+t241+t242+t243+t244;
double t0 = sqrt(t178)*(beta1*t179*(t49*t81*t93*((t55/fabs(t55)))*2.0+t57*t76*t94*((t63/fabs(t63)))*2.0+t67*t76*t95*((t73/fabs(t73)))*2.0)-beta1*1.0/(t92*t92)*t183*(t22*t77*t81*((t79/fabs(t79)))*2.0+t41*t76*t82*((t84/fabs(t84)))*2.0+t48*t76*t86*((t88/fabs(t88)))*2.0))-1.0/sqrt(t178)*(beta2-beta1*t179*t183)*(t168*(t7*t9*t140-r2*t7*t9*t223+r5*t13*t15*t227+r8*t19*t21*t231+r2*t1*t7*t9*t140-r2*t1*t56*t140*t199*2.0)+t173*(-t7*t9*t152+r2*t7*t9*t245+r5*t13*t15*t235+r8*t19*t21*t239-r2*t1*t7*t9*t152+r2*t1*t56*t152*t199*2.0)-t177*(-r3*t7*t9*t223+r6*t13*t15*t227+r9*t19*t21*t231+r3*t1*t7*t9*t140-r3*t1*t56*t140*t199*2.0)-t164*(r3*t7*t9*t245+r6*t13*t15*t235+r9*t19*t21*t239-r3*t1*t7*t9*t152+r3*t1*t56*t152*t199*2.0))*(1.0/2.0);
