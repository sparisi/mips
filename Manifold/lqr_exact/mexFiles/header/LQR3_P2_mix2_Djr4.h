#ifndef LQR3_P2_mix2_Djr4_H
#define LQR3_P2_mix2_Djr4_H

double LQR3_P2_mix2_Djr4(double* tv, int tdim, double* param, int pdim) {
...
double t62 = t57*t61;
double t63 = t62-1.0;
double t64 = t13*t15*1.8E1;
double t75 = t13*t56*1.8E1;
double t65 = t64-t75;
double t66 = 1.0/(t31*t31);
double t67 = 1.0/AUp3;
double t72 = t67*t71;
double t73 = t72-1.0;
double t74 = t13*t32*t56*1.962E3;
double t95 = t46*t65*t66*1.09E3;
double t76 = t74-t95;
double t80 = t22*t22;
double t84 = t41*t41;
double t88 = t48*t48;
...
double t185 = t13*t15*t32*1.962E3;
double t186 = t13*t15*t46*t66*1.962E4;
double t187 = t13*t56*t66*t101*1.962E3;
double t193 = t28*t65*t66*1.962E3;
double t194 = t46*t65*t101*t184*2.18E3;
double t188 = t185+t186+t187-t193-t194;
double t189 = t13*t15*t32*2.18E2;
double t190 = t13*t15*t51*t66*1.962E4;
double t191 = t13*t56*t66*t101*2.18E2;
double t200 = t28*t65*t66*2.18E2;
double t201 = t51*t65*t101*t184*2.18E3;
...
double t202 = r5*t13*t15*t192;
double t203 = r5*t56*t118*t199*2.0;
double t204 = -t119+t202+t203;
double t205 = r5*t13*t15*t188;
double t206 = r5*t56*t114*t199*2.0;
double t207 = -t115+t205+t206;
double t208 = t120*t192;
double t209 = t122*t188;
double t210 = t127*t188;
double t211 = t118*t204;
double t212 = t114*t207*2.0;
double t213 = t208+t209+t210+t211+t212;
double t214 = t104*t204;
double t215 = t100*t207;
double t216 = t104*t207;
double t217 = t214+t215+t216;
double t218 = t109*t204;
double t219 = t125*t207;
double t220 = t109*t207;
double t221 = t218+t219+t220;
double t222 = r6*t13*t15*t192;
double t223 = r6*t56*t118*t199*2.0;
double t224 = -t131+t222+t223;
double t225 = r6*t13*t15*t188;
double t226 = r6*t56*t114*t199*2.0;
double t227 = -t130+t225+t226;
double t228 = t132*t192;
double t229 = t134*t188;
double t230 = t136*t188;
double t231 = t118*t224;
double t232 = t114*t227*2.0;
double t233 = t228+t229+t230+t231+t232;
double t234 = t104*t224;
double t235 = t100*t227;
double t236 = t104*t227;
double t237 = t234+t235+t236;
double t238 = t109*t224;
double t239 = t125*t227;
double t240 = t109*t227;
double t241 = t238+t239+t240;
double t0 = -sqrt(t178)*(beta1*t179*(t57*t76*t90*((t63/fabs(t63)))*2.0+t49*t91*t94*((t55/fabs(t55)))*2.0+t67*t76*t92*((t73/fabs(t73)))*2.0)-beta1*1.0/(t89*t89)*t183*(t22*t76*t77*((t79/fabs(t79)))*2.0+t48*t76*t85*((t87/fabs(t87)))*2.0+t41*t81*t94*((t83/fabs(t83)))*2.0))+1.0/sqrt(t178)*(beta2-beta1*t179*t183)*(t168*(-t162+r2*t7*t9*t217+r5*t13*t15*t213+r8*t19*t21*t221+r5*t56*t144*t199*2.0)-t177*(-t171+r3*t7*t9*t217+r6*t13*t15*t213+r9*t19*t21*t221+r6*t56*t144*t199*2.0)+t164*(-t166+r3*t7*t9*t237+r6*t13*t15*t233+r9*t19*t21*t241+r6*t56*t156*t199*2.0)-t173*(-t175+r2*t7*t9*t237+r5*t13*t15*t233+r8*t19*t21*t241+r5*t56*t156*t199*2.0))*(1.0/2.0);
