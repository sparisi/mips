...
% EVALUATE_POLICIES_EPISODIC Given a set of high-level POLICIES, it returns 
% the corresponding return J in the objectives space.
% Set MAKEDET to 1 if you want to make the policies deterministic.

[n_obj, ~, episodes] = feval([domain '_settings']);
